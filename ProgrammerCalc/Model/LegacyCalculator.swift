...
class LegacyCalculator: LegacyCalculatorProtocol {
    ...
    // Calculate result
    fileprivate func calculateBuffWith(_ inputValue: NumberSystemProtocol, _  operation: CalcMath.OperationType) -> String {
    ...
    public func calculateResult( inputValue: NumberSystemProtocol, operation: CalcMath.OperationType) -> String {
    ...
    private func isBitwiseOperation(_ operation: CalcMath.OperationType) -> Bool {
        return operation == .shiftLeft || operation == .shiftRight
    }
    
    fileprivate func calculateSoloBitwise(_ inputValue: NumberSystemProtocol, _ operation: CalcMath.OperationType) -> String {
    ...
    func getOperationBy(string: String) -> CalcMath.OperationType? {
        switch string {
        case "÷":
            return .div
        case "×":
